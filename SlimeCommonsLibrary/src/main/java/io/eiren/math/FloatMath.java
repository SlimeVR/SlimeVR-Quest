...
public class FloatMath {
	...
	public static final float ANGLE_EPSILON = 0.028f; // in degrees (float epsilon for sin/cos)
	 ...
	 */
	public static float mapValue(float value, float sourceStart, float sourceEnd, float targetStart, float targetEnd) {
	 ...
	 */
	public static float mapValueWithClampBefore(float value, float sourceBottom, float sourceTop, float targetBottom, float targetTop) {
		return mapValue(clamp(value, sourceBottom, sourceTop), sourceBottom, sourceTop, targetBottom, targetTop);
	}
	 ...
	 */
	public static float mapValueWithClampAfter(float value, float sourceBottom, float sourceTop, float targetBottom, float targetTop) {
		return clamp(mapValue(value, sourceBottom, sourceTop, targetBottom, targetTop), targetBottom, targetTop);
	}
	...
	public static Vector3f unsignedInt2101010RevNormalizedToFloats(int packedValue, Vector3f store) {
	...
	public static Vector4f unsignedInt2101010RevNormalizedToFloats(int packedValue, Vector4f store) {
		store = unsignedInt2101010RevToFloats(packedValue, store);
		store.x /= TEN_BITS;
		store.y /= TEN_BITS;
		store.z /= TEN_BITS;
